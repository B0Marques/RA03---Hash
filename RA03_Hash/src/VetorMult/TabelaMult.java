...
public class TabelaMult {
    public static TabelaHash[][] mainmult(String[] args) {
        ...
        for (int i = 0; i < 5; i++) {
            for (int j = 0; j < 5; j++) {
                ...
                System.out.println("Tamanho (Multiplicação): " + tamTabela[i] + " Quantidade de dados: " + qtdDados[j]);
